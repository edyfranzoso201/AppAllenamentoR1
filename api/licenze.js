...
function setCors(req, res) {
  ...
  // cross-origin (prima invece rispondevamo col dominio prod, vanificando
  // il controllo). Le richieste senza header Origin (same-origin, cron,
  // server-to-server, curl) non sono soggette a CORS e passano comunque.
