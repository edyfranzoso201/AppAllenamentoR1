// api/data.js - Multi-annata CON PROTEZIONE dati 2012
...
export default async function handler(req, res) {
  ...
  // Leggi l'annata dall'header (se manca, usa le chiavi legacy per retrocompatibilità)
  ...
  try {
    if (req.method === 'GET') {
      ...
      // CASO 1: Richiesta SENZA header (modalità legacy o backup completo)
      if (!annataId) {
        console.log('📥 GET legacy/2012 (chiavi globali)');
        data = {
      ...
      // CASO 2: Annata 2012 - USA LE CHIAVI LEGACY (per compatibilità)
      ...
      // CASO 3: Altre annate (2013, 2014...) - USA CHIAVI SEPARATE
      else {
    ...
    if (req.method === 'POST') {
      ...
      // CASO 1: Salvataggio SENZA header (modalità legacy)
      if (!annataId) {
        console.log('💾 POST legacy/2012 (chiavi globali)');
      ...
      // CASO 2: Annata 2012 - USA LE CHIAVI LEGACY
      else if (annataId === '2012') {
