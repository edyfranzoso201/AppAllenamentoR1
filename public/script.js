...
(function checkAnnataBeforeInit() {
    ...
    // ✅ CONTROLLO CRITICO: Annata deve essere selezionata
    ...
    if (!currentAnnata) {
        ...
        console.log('💡 L\'utente deve selezionare un\'annata per procedere');
        throw new Error('No annata selected - Dashboard initialization blocked');
    }
