...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ✅ LOGIN: carica i dati SOLO DOPO autenticazione
    ...
    // ✅ loadData: funziona su Vercel (URL assoluto non necessario se /api è configurato)
    ...
    // ✅ Resto del codice (renderFormation, renderCalendar, ecc.) identico al tuo originale
    // ... (mantieni esattamente come nel tuo file originale) ...

    // --- Inizializzazione ---
    // ✅ NON caricare dati all'avvio! Aspetta il login.
    showLogin();
});