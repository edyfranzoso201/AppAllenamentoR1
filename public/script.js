...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ✅ MODIFICA: Aggiunto campo "Assenza Giustificata" nel modale di valutazione
    ...
    // ✅ Aggiunta la categoria "assenza-giustificata"
    ...
    // ✅ Modifica: escludi 'assenza-giustificata' dal punteggio totale
    ...
    elements.evaluationForm.addEventListener('submit', (e) => {
        ...
        // ✅ Salva esplicitamente l'assenza giustificata
        evaluations[date][athleteId]['assenza-giustificata'] = document.getElementById('assenza-giustificata').value;
