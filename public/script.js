...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ✅ MODIFICA 1: Aggiunta opzione "4-Assenza Giustificata" nel select di "Presenza Allenamento"
    ...
    // ✅ MODIFICA 2: Le categorie rimangono le stesse, ma "presenza-allenamento" ora include il valore 4
    ...
    const loadData = async () => {
        try {
            ...
            // ✅ Assicurati che tutti gli atleti abbiano la proprietà `isGuest`
    ...
    // ✅ MODIFICA 3: Calcola punteggio escludendo "Assenza Giustificata" (valore 4)
    const calculateAthleteScore = (evaluation) => {
        ...
        for (const [key, value] of Object.entries(evaluation)) {
            ...
            // Escludi "Assenza Giustificata" (valore 4)
