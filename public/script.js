...
document.addEventListener('DOMContentLoaded', () => {
    ...
    athletes.forEach(athlete => {
        ...
        // Controlla se c'è un'assenza giustificata per la data selezionata
        ...
        if (currentDate && evaluations[currentDate] && evaluations[currentDate][athlete.id]) {
            ...
            if (presenzaValue === 4) {
                absenceJustifiedBadge = '<span class="badge absence-justified-badge ms-1" title="Assenza Giustificata"><i class="bi bi-check-circle"></i></span>';
                absenceJustifiedClass = 'absence-justified';
            }
        }
    ...
    // Salva tutte le valutazioni incluso il valore "4" per Assenza Giustificata
    evaluations[date][athleteId] = {
        'presenza-allenamento': document.getElementById('presenza-allenamento').value,
        'serieta-allenamento': document.getElementById('serieta-allenamento').value,
        'abbigliamento-allenamento': document.getElementById('abbigliamento-allenamento').value,
        'abbigliamento-partita': document.getElementById('abbigliamento-partita').value,
        'comunicazioni': document.getElementById('comunicazioni').value,
        'doccia': document.getElementById('doccia').value
    };
