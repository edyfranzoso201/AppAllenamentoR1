...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const PARENT_FIELDS = ['nome','cognome','telefono','cf','email','indirizzo'];
    ...
    window.resetIndividualPkg = function(athleteId) {
        if (!athleteId) { athleteId = document.getElementById('modal-athlete-id')?.value; }
        if (!athleteId) return;
