...
(function() {
  ...
  try {
    ...
    if (annataFromUrl) {
        ...
        window.currentAnnata = annataFromUrl;
        console.log('[PRESENZA MODE] ⚡ Annata da URL:', annataFromUrl);
    } else {
        // Altrimenti, ottieni l'annata più recente (usando .then invece di await)
